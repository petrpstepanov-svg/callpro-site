...
export const config = {
  ...
  // SEO
  seoTitle: "CallPro — Холодные звонки B2B в Москве | Колл-центр на аутсорсе",
  seoDescription:
    "Профессиональный обзвон для B2B: холодные звонки, телемаркетинг, актуализация баз. Оплата за результат от 80 ₽/лид. Запуск за 3–5 дней. Москва.",
  seoKeywords: [
    "холодные звонки b2b",
